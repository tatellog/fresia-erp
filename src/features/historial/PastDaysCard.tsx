...
/**
 * Captura, corrección y borrado de un día pasado (corte en papel) por forma
  ...
  return (
    <div>
      <p className="mb-4 text-sm text-berry-700/70">
        ¿Este día quedó vacío o con montos equivocados? Captura el corte en papel por forma de pago.
      ...
      {posTotal > 0 && (
        <p className="mb-3 rounded-xl bg-cream-200/60 px-3 py-2 text-xs text-berry-700/70">
          Este día también tiene {money(posTotal)} vendidos desde el POS; lo que captures aquí se suma aparte.
        </p>
      )}
      ...
      <div className="flex gap-2">
        <Button className="flex-1" disabled={total <= 0} onClick={guardar}>
