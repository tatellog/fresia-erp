import { BanknoteIcon, CreditCardIcon, BankIcon, ReceiptIcon } from '../../components/ui/icons'
import { money } from '../../lib/format'
import { CashSummaryCard } from './CashSummaryCard'

/** hero de Caja: efectivo esperado, tarjeta, transferencias y total del día */
export function DailyTotals({ expected, card, transfer, total, open }: {
  expected: number
  card: number
  transfer: number
  total: number
